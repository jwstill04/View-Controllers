...
//Foo is declared in the scope of the loop rather than the global scope where line 10 is
...
//x was declared in the global scope and only modified in the loop
...
greeting(greeting: "Hi there", name: "Jon")
greeting(greeting: nil, name: "Jon")
